...
# WHY: the version bumps but both KUBECTL_SHA values stay v1.37.0's — the docker
# WHY: build fails at sha256sum -c on the day someone rebuilds, or worse, a mirror
# WHY: serving the old binary verifies clean. The exact defect a lazy bump produces.
