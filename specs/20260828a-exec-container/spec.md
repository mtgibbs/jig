...
The loop must not learn anything new. `specs/20260825c-executor-binding` §3/§7 makes a binding thin by
...
clear would fail the final task forever under `specs/20260827c-last-task-strict` — and a gate that cannot
