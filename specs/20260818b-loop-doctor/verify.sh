#!/usr/bin/env bash
# verify.sh — deterministic acceptance gate for specs/20260818b-loop-doctor.
# Run from repo root:  ./specs/20260818b-loop-doctor/verify.sh   (STRICT=1 for the final convergence pass)
#
...
FIX="specs/20260818b-loop-doctor/fixtures"
S="$FIX/status"
L="$FIX/logs"
...
# Litter: nothing may appear under specs/20260818b-loop-doctor/ outside the allowed set.
stray="$(find specs/20260818b-loop-doctor -type f \
  ! -name spec.md ! -name tasks.txt ! -name verify.sh \
  ! -path 'specs/20260818b-loop-doctor/fixtures/*' ! -path 'specs/20260818b-loop-doctor/evidence/*' 2>/dev/null)"
