# Red-before-green evidence — `specs/20260818b-loop-doctor/verify.sh`
...
- **Hold it back** — let `run-loop.sh build-converge specs/20260818b-loop-doctor` build it fresh. This spec
