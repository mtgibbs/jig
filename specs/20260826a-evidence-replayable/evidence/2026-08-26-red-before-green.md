# Red before green — `specs/20260826a-evidence-replayable`

Run against `1ea0c6e` with **no task built**, from `~/dev/harness-evidence`.

```
$ bash specs/20260826a-evidence-replayable/verify.sh   ; echo $?      → 0   (14 pend, 6 PASS, 0 FAIL)
$ STRICT=1 bash specs/20260826a-evidence-replayable/verify.sh; echo $? → 1
```
