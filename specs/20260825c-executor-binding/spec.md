...
- **AC-7** The build loop plus its executor bindings shall total **fewer lines than the two
  ...
  > red the moment `specs/20260818b-loop-doctor` landed ~250 lines of new capability, failing an unrelated
...
`specs/20260825c-executor-binding/verify.sh` — STATIC, three-verdict, `STRICT=1` promotes pend. Executing
