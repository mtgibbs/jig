#!/usr/bin/env bash
# specs/spec-manifest/verify.sh — the deterministic gate for "a spec declares what it needs,
...
SELF="$R/specs/spec-manifest/spec.md"
...
_stray="$(find "$R/specs/spec-manifest" -maxdepth 1 -mindepth 1 \
