...
# WHY: the central set drops RALPH_SATISFIED_TIMEOUT, which one local copy covered. Deleting the
# WHY: local copies then UN-quarantines it silently — the migration loses a variable and every
# WHY: gate still passes.
