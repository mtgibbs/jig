...
# WHY: reads GATE_TMPDIR into a variable and then calls bare mktemp -d anyway. The variable is
# WHY: documented, greppable and inert — an operator sets it, nothing moves, and the only
# WHY: remaining option is relaxing the container.
