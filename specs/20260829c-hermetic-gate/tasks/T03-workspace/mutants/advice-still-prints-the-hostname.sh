...
# WHY: factors the diagnostic into a function, as asked, and has it print the hostname — the
# WHY: same fact about the machine the old inline echo printed, now behind a nicer seam.
