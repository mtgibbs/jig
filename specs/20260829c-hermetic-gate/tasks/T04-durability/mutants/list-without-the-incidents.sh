...
# WHY: keeps the reset and strips the incidents to a bare list. Correct, and it teaches the next
# WHY: person nothing about what earns a slot — so the quarantine grows on suspicion until it
# WHY: unsets something a gate needed.
