...
# WHY: quarantines four of the five and drops RALPH_SATISFIED_TIMEOUT — the one whose damage is
# WHY: invisible, because a gate that sets it per case is overridden without any error at all.
