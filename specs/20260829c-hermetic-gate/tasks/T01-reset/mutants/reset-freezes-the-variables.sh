...
# WHY: makes the variables readonly so "nothing can set them" — which also stops a GATE setting
# WHY: one deliberately for the case it is testing. This spec own T01 ac02 could not be written
# WHY: against it: the reset must bound the launching shell, not the gate.
