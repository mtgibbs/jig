...
# WHY: defines gate_env_reset and never calls it. The function is there, greppable, correct —
# WHY: and every gate still inherits everything, which is the shape of both local patches this
# WHY: spec replaces: a rule that has to be invoked.
