...
# WHY: clears the set in run_gates AFTER the gate has been invoked. The construct is present and
# WHY: a grep for it passes; the gate ran with the launching shell environment intact, which is
# WHY: the only moment that mattered.
#!/usr/bin/env bash
