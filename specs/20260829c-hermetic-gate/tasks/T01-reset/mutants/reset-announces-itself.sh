...
# WHY: announces the reset on load. Helpful-looking, and it breaks every assertion in other
# WHY: specs that compares a gate stdout — assert.sh header says it must not run anything on load
# WHY: for exactly this reason.
