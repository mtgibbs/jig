# Red before green — `specs/20260825b-evidence-spec-nesting/verify.sh`
...
| **Reproduce** | `git worktree add /tmp/pre197 --detach e669455 && cp -r specs/20260825b-evidence-spec-nesting /tmp/pre197/specs/ && cd /tmp/pre197 && bash specs/20260825b-evidence-spec-nesting/verify.sh` |
