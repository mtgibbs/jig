...
### Out of scope
- **`RALPH_STATUS_KEEP_MIN`'s 1440 default.** Pinned by `specs/20260825a-evidence-convention` AC-4 and
...
- `specs/20260825a-evidence-convention` AC-1's gate reads the **first** `HB_DIR=` line and requires the
...
- `specs/20260825a-evidence-convention` AC-5 forbids any project's name appearing in a `scripts/loop-*`
...
`specs/20260825b-evidence-spec-nesting/verify.sh` — STATIC, hermetic, three-verdict, `STRICT=1` promotes
