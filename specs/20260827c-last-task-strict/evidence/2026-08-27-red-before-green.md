# Red before green — `specs/20260827c-last-task-strict`
...
```
$ bash        specs/20260827c-last-task-strict/verify.sh ; echo $?   → 0   (4 pend, 5 PASS, 0 FAIL)
$ STRICT=1 bash specs/20260827c-last-task-strict/verify.sh ; echo $? → 1
```
...
The lesson from `specs/20260827b-fleet-run-key`: validating against a stub is **one action per presence
