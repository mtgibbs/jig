#!/usr/bin/env bash
# specs/20260827c-last-task-strict/verify.sh — the deterministic gate for "the last task's gate is the
# strict gate".
#
...
_stray="$(find "$R/specs/20260827c-last-task-strict" -maxdepth 1 -mindepth 1 \
