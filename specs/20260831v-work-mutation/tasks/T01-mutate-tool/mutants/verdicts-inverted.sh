...
# WHY: NOTICED and UNNOTICED are swapped at the verdict site. Every downstream count,
# WHY: row, and summary reads exactly backwards — the classic sign flip that survives a
# WHY: skim because both words appear where words should appear.
#!/usr/bin/env bash
