...
# WHY: the drop-line probe edits the REAL repository file instead of the hermetic copy,
# WHY: and the restore step only ever restores the copy — the instrument damages the
# WHY: thing it was supposed to be measuring a photograph of.
#!/usr/bin/env bash
