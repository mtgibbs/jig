...
# WHY: reports the LEDGER's exit code instead of the worst corpus verdict — the
# WHY: sweep goes green over a survivor as long as rendering worked. qwen's
# WHY: attempt-2 misread, verbatim: 'exit code is 0 because the ledger succeeded'.
#!/usr/bin/env bash
