...
# WHY: the dry-run flag's closing fi is gone. Everything else is intact, the file
# WHY: looks complete at a glance, and nothing that greps for features notices —
# WHY: only bash -n does.
#!/usr/bin/env bash
