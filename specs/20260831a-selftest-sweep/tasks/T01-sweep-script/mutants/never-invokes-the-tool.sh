...
# WHY: prints the banner and never runs gate-selftest.sh. The sweep LOOKS busy,
# WHY: no rows land, and the ledger has nothing to render — qwen's actual
# WHY: attempt-1 bug (real mode never invoked the tool).
#!/usr/bin/env bash
