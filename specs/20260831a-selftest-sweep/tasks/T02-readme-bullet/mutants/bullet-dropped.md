...
# WHY: the sweep bullet is simply gone. The README is otherwise intact and
# WHY: plausible — a presence check that greps too loosely still matches the
# WHY: word 'sweep' elsewhere in this repo's prose.
