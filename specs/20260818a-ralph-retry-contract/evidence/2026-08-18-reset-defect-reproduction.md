...
(`specs/20260802a-judge-loop/reviews/2026-08-02-codex-planning-check.md`, finding #4). It was fixed there
...
`specs/20260818a-ralph-retry-contract/verify.sh`, compiled 2026-08-18, run **before any fix exists**.
...
`specs/20260818b-loop-doctor/evidence/2026-08-18-red-before-green.md` §4, which matched a comment).
...
`run-loop.sh build-converge specs/20260818a-ralph-retry-contract`, driven from an **isolated copy** of
